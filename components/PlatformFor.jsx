...
const PlatformFor = () => {
  ...
  const cats = [
    ...
    },
    {
      ...
      img: R('pfCharts','assets/product/pf-charts.png'),
      ...
      cta: { label: 'View Sample Demo Dashboard' },
    },
    {
      label: 'Reports & Alerts',
      img: R('pfReports','assets/product/pf-reports.png'),
