...
const FAQ_DATA = [
  ...
  { g: 'Pricing, support, and consulting', qs: [
    ...
    'Do you also provide consulting and implementation support?',
...
window.FAQ_ANSWERS = {
  ...
  'How is Dalgo priced?': `<p>Dalgo SaaS costs <strong>&#8377;2.04 lakh per organisation per year</strong>, or <strong>&#8377;17,000 per month</strong> in India. For international nonprofits, it costs <strong>US$3,000 per year</strong> or <strong>US$250 per month</strong>. This is a flat organisation-level price that never charges per user or per pipeline.</p><p>All core Dalgo capabilities are included: data ingestion, transformations, pipelines, native dashboards, charts, KPIs, alerts, data quality, reporting, user access controls, and support. Consulting and implementation services are priced separately — from &#8377;2,500/hour in India or US$35/hour internationally. See the <a href="pricing.html">Dalgo pricing page</a> for details.</p>`,
  ...
  'When should we choose Dalgo rather than build a custom data platform?': `<p>Dalgo is a strong option when you need a reliable, nonprofit-oriented data foundation without taking on the full cost and maintenance burden of a custom platform. It uses open-source components, supports a modern warehouse-and-transformation approach, and comes with implementation and social-sector experience.</p><p>A fully custom platform may make sense when you have unusually specialised product requirements, a large in-house engineering team, or non-standard operational constraints. We can help you weigh the trade-offs together.</p>`,
